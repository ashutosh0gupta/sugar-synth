...
The method always terminates because the search space of rules is finite. The set of rules synthesized need not minimal. They also need not be unique. The solver reports the first set which satisfies the constraints.
...
\choosefinal{We support the variations, which is presented in 
  the extended version of this paper is available at~\cite{arxiv-this}.}{We support the variations.}
