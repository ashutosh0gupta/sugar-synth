...
Now let us define the model of the production process of the molecules.
...
\begin{wrapfigure}{r}{0.37\textwidth}
  ...
  % (b)
  % \end{minipage}
  \caption{(a) An example rule. (b) An application of the rule.}
  \label{fig:exrule}
  \vspace{-8mm}
\end{wrapfigure}
\paragraph{Example:} In Figure~\ref{fig:exrule}(a), we present a rule. That has
  two kinds of nodes.
