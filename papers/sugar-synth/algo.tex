...
\begin{figure}[t]
        \center
  \begin{tikzpicture}[shorten >=1pt,thick,node distance=2cm,on grid]
    \node[loc] (v0) {$v_0$};
...
In the method, the call to $\textsc{RuleTemplateCorrectness}$ at
...
Let us consider the body of the loop in detail.
