...
{\em Implementation:} 
We have implemented \textsc{SugarSynth} in a tool {\ourtool}~\cite{Charles2013}.
%
The tool, written in {\tt C++}, uses {\zthree}\cite{z3} as the SMT solver
to solve the satisfiability queries. We ran the experiments  on a laptop with 8GB RAM and 2.4GHz CPU.
%
...
are included in the Appendix~\ref{sec:ex-variants}.} %\hyperref[sec:appendix]{}.
